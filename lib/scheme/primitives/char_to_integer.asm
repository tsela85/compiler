...
CHAR_TO_INTEGER:
        ...
        CMP(INDD(FPARG(2),0),T_CHAR); //checks arg 1 is integer
        JUMP_NE(CHAR_TO_INTEGER_NOT_A_INTEGER) ;
        PUSH(INDD(FPARG(2),1));
...
CHAR_TO_INTEGER_NOT_VALID_ARGUMENTS:
        SHOW("CHAR_TO_INTEGER_GT -not a valid number of args",FPARG(1)) ;
        STOP_MACHINE ;
        return 1;
CHAR_TO_INTEGER_NOT_A_INTEGER:
